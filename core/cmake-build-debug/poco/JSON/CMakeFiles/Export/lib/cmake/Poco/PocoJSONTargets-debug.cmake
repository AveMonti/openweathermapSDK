...
set_target_properties(Poco::JSON PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libPocoJSONd.80.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libPocoJSONd.80.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::JSON )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::JSON "${_IMPORT_PREFIX}/lib/libPocoJSONd.80.dylib" )
