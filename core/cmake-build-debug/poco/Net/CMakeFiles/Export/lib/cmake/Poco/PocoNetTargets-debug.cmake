...
set_target_properties(Poco::Net PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libPocoNetd.80.dylib"
  IMPORTED_SONAME_DEBUG "@rpath/libPocoNetd.80.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::Net )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::Net "${_IMPORT_PREFIX}/lib/libPocoNetd.80.dylib" )
